          ...
          <div class="card-body">
            <form method="POST" action="{{ route('storeTrip') }}" id="tripform" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                <label for="start_point" class="col-md-4 col-form-label text-md-right">
                  {{ __('Starting point') }}
                </label>
                <div class="col-md-6">
              ...
              <div class="form-group row">
                <label for="end_point" class="col-md-4 col-form-label text-md-right">
                  {{ __('End point') }}
                </label>
                <div class="col-md-6">
              ...
              <div class="form-group row">
                  <label for="seats_available" class="col-md-4 col-form-label text-md-right">
                    {{ __('Seats available') }}
                  </label>
                  <div class="col-md-6">
                    <input id="seats_available" type="number" min="1" max="45"
              ...
              <div class="form-group row">
                <label for="car_description" class="col-md-4 col-form-label text-md-right">
                  {{ __('Car description') }}
                </label>
                <div class="col-md-6">
                  <textarea id="car_description"
                    class="form-control @error('car_description') is-invalid @enderror"
                    name="car_description" rows="2" cols="44" form="tripform"
                    maxlength="255" wrap="hard" required
              ...
              <div class="form-group row">
                <label for="trip_info" class="col-md-4 col-form-label text-md-right">
                  {{ __('Trip info') }}
                </label>
                <div class="col-md-6">
                  <textarea id="trip_info"
                    class="form-control @error('trip_info') is-invalid @enderror"
                    name="trip_info" rows="4" cols="44" form="tripform" maxlength="255"
              ...
              <div class="form-group row">
                <label for="pets_allowed" class="col-md-4 col-form-label text-md-right">
                  {{ __('Pets allowed') }}
                </label>
                <div class="col-md-6 flex flex align-items-center">
                  <input type="hidden" name="pets_allowed" value="0">
                  <input id="pets_allowed" type="checkbox" class="btn-group-toggle"
                    name="pets_allowed" value="{{ old('pets_allowed', 1) }}"
                    autocomplete="pets_allowed">
                </div>
              </div>

              <div class="form-group row">
                <label for="kids_allowed" class="col-md-4 col-form-label text-md-right">
                  {{ __('Kids allowed') }}
                </label>
                <div class="col-md-6 flex flex align-items-center">
                  <input type="hidden" name="kids_allowed" value="0">
                  <input id="kids_allowed" type="checkbox" class="btn-group-toggle"
                    name="kids_allowed" value="{{ old('kids_allowed', 1) }}"
                    autocomplete="kids_allowed">
                </div>
              </div>

              <div class="form-group row">
                  <label for="trip_image" class="col-md-4 col-form-label text-md-right">
                    {{ __('Image (Optional)') }}
                  </label>
                  <div class="col-md-6">
                    <input id="trip_image" type="file"
