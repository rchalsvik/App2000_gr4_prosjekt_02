          ...
          <div class="card-body">
            <form method="GET" action="{{ route('searchShow') }}" id="tripform">
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  <label for="trip_active" class="col-md-4 col-form-label text-md-right">
                    {{ __('Active trips only') }}
                  </label>
                  <div class="col-md-6 flex flex align-items-center">
                ...
                <div class="card mb-1 h-100">
                  <div class="card-body @if(!$trip->trip_active) card-deactive @endif">
                    ...
                    <div class="item-container flex-jc-sb item-c-100 mb-3">
                      ...
                      <div class="ml-4 font-weight-bolder flex align-items-start
                                  @if($trip->trip_active) text-active
                                  @else text-deactive @endif  ">
                        @if ($trip->trip_active)
                          {{ __('Active') }}
                          <img class="ml-2 mt-n-1" src="/img/icons/active.svg"
                               alt="{{ __('Active') }}">
                        @else
                          {{ __('Not Active') }}
                          <img class="ml-2 mt-n-1" src="/img/icons/deactive.svg"
                               alt="{{ __('Not Active') }}">
                        @endif
                      </div>
                    </div>
